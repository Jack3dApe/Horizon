...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Navbar and Footer Language Lines
    |--------------------------------------------------------------------------
    */
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Login/Signup/ForgotPassword/ResetPassword Language Lines
    |--------------------------------------------------------------------------
    */
    'login' => 'Entrar',
    'welcome' => 'Bem-vindo ao Horizon',
    ...
    */
    ...
    'password_placeholder' => '8 - 15 Carateres',
    'repassword_label' => 'Repetir Palavra-passe',
    'repassword_placeholder' => '8 - 15 Carateres',
    ...
    */
    ...
    'welcomeservmsg' => 'Bem-vindo ao nosso sistema de suporte! Aqui podes esclarecer algumas das dúvidas mais comuns entre os nossos clientes.',
    'whoweare' => 'Quem somos?',
    ...
    'wherearewe' => 'Onde nos situamos?',
    'wherearewemsg' => 'Portugal, Palmela - Atec (Training Academy).',
    'paymentmethodscreditpaypal' => 'Métodos de pagamento',
