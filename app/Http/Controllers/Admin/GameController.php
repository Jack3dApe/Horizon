...
class GameController extends Controller
{
    ...
    public function deleted()
    {
        ...
        return view('admin.trash.games.deleted', compact('games'));
    }
    ...
    public function gamesByGenre($genreId)
    {
        ...
        return view('games.by-genre.index', compact('genre', 'games'));
    }
    ...
    public function showGame(Game $game)
    {
        ...
        return view('games.mainpage.show', compact('game', 'isWishlisted', 'reviewExists', 'gameOwned'));
    }
