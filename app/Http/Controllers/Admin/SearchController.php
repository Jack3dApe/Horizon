...
class SearchController extends Controller
{
    ...
    public function searchTickets(Request $request)
    {
        ...
        return view('support.index', compact('tickets', 'query'));
    }
    ...
    public function searchDeletedUsers(Request $request)
    {
        ...
        return view('admin.trash.users.deleted', compact('users', 'query'));
    }
    ...
    public function searchDeletedReviews(Request $request)
    {
        ...
        return view('admin.trash.reviews.deleted', compact('reviews', 'query'));
    }
    ...
    public function searchDeletedPublishers(Request $request)
    {
        ...
        return view('admin.trash.publishers.deleted', compact('publishers', 'query'));
    }
    ...
    public function searchDeletedGames(Request $request)
    {
        ...
        return view('admin.trash.games.deleted', compact('games', 'query'));
    }
    ...
    public function searchDeletedGenres(Request $request)
    {
        ...
        return view('admin.trash.genres.deleted', compact('genres', 'query'));
    }
    ...
    public function aiSearch(Request $request, OpenAIService $openAIService)
    {
        ...
        return view('search.ai', compact('games'));
    }
