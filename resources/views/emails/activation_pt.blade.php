...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td align="center" bgcolor="#FFFFFF" style="padding: 40px 20px;">
            <p style="font-size: 16px; color: #666666; margin-bottom: 20px;">Por favor, clique no botão abaixo para ativar seu email:</p>
            <a href="{{ $link }}" style="background-color: #e53637; color: #ffffff; padding: 15px 25px; text-decoration: none; font-size: 16px; border-radius: 5px; display: inline-block; margin: 20px 0;">Ativar Email</a>
