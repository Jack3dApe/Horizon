...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td align="center" bgcolor="#FFFFFF" style="padding: 40px 20px;">
            <p style="font-size: 16px; color: #666666; margin-bottom: 20px;">Click the button below to reset your password:</p>
            <a href="{{ $link }}" style="background-color: #e53637; color: #ffffff; padding: 15px 25px; text-decoration: none; font-size: 16px; border-radius: 5px; display: inline-block; margin: 20px 0;">Reset Password</a>
            <p style="margin-top: 10px; font-size: 14px; color: #666666;">Or click this link: <a href="{{ $link }}" style="color: #0b0c2a;">{{ $link }}</a></p>
            <p style="font-size: 14px; color: #666666; margin-top: 20px;">If you did not request this, ignore this email.</p>
        </td>
    </tr>
    <tr>
